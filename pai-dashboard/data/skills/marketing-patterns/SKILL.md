...
```bash
ls ~/Documents/projects/fabric/data/my_patterns/
```

**List BethanyWorks patterns:**
```bash
ls ~/Documents/projects/fabric/data/BethanyWorks/patterns/
```

**View pattern details:**
```bash
cat ~/Documents/projects/fabric/data/my_patterns/[pattern_name]/system.md
```

## Integration with Glow Social

These patterns can be integrated into Glow Social:
- Pre-generate 96 hooks during onboarding
- Use as AI prompt templates
- Content generation pipeline
- Performance analysis feedback loop
- Client-specific voice customization
